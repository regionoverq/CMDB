    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.CharField(max_length=128, null=True, verbose_name='备注')),
                ('price', models.IntegerField(verbose_name='合同金额')),
                ('detail', models.TextField(blank=True, null=True, verbose_name='合同详情')),
                ('start_day', models.DateField(blank=True, null=True, verbose_name='开始时间')),
                ('end_day', models.DateField(blank=True, null=True, verbose_name='结束时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(blank=True, choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevice', '存储设备'), ('securitydevice', '安全设备'), ('software', '软件资产')], default='server', max_length=64, verbose_name='资产类型')),
                ...
                ('cpu_model', models.CharField(blank=True, max_length=128, null=True, verbose_name='内存大小')),
                ('cpu_count', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='cpu物理核心数')),
                ('cpu_core_count', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='cpu核心数')),
                ...
                ('m_time', models.DateTimeField(auto_now_add=True, verbose_name='修改日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '磁盘阵列'), (1, '网络存储器'), (2, '磁带库'), (4, '磁带机')], default=0, verbose_name='存储设备')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, 'PC服务器'), (1, '刀片机'), (3, '小型机')], default=0, verbose_name='服务器类型')),
                ('created_by', models.CharField(choices=[('auto', '自动添加'), ('manual', '手动录入')], default='auto', max_length=32, verbose_name='录入方式')),
                ('model', models.CharField(blank=True, max_length=128, null=True, verbose_name='服务器类型')),
                ...
                ('os_distribution', models.CharField(blank=True, max_length=64, null=True, verbose_name='发行商')),
                ('os_release', models.CharField(blank=True, max_length=64, null=True, verbose_name='发行版本')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.asset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(default='未知型号', max_length=128, verbose_name='安全设备类型')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.asset')),
            ],
            options={
                'verbose_name': '安全设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '路由器'), (1, '交换机'), (2, '负载均衡'), (3, 'VPN设备')], default=0, max_length=32, verbose_name='网络设备类型')),
                ('vlan_ip', models.GenericIPAddressField(blank=True, null=True, verbose_name='VlanIP')),
                ('intranet_ip', models.GenericIPAddressField(blank=True, null=True, verbose_name='内网IP')),
                ('model', models.CharField(default='未知类型', max_length=30, verbose_name='网络设备类型')),
                ...
                ('device_detail', models.TextField(blank=True, null=True, verbose_name='详情配置')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.asset')),
            ],
            options={
                'verbose_name': '网络设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cup_model', models.CharField(blank=True, max_length=128, null=True, verbose_name='CPU型号')),
                ('cup_count', models.PositiveSmallIntegerField(default=1, verbose_name='物理CPU个数')),
        ...
        migrations.AddField(
            model_name='asset',
            name='admin',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='admin', to='assets.contract', verbose_name='资产管理员'),
        ),
        migrations.AddField(
            model_name='asset',
            name='approved_by',
        ...
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='assets.businessunit', verbose_name='所属业务'),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
        ...
        migrations.AddField(
            model_name='asset',
            name='manufacturer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='assets.manufacturer', verbose_name='制作商'),
        ),
        migrations.AddField(
            model_name='asset',
            name='tags',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sn', models.CharField(blank=True, max_length=128, null=True, verbose_name='SN型号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer', models.CharField(blank=True, max_length=128, null=True, verbose_name='磁盘制作商')),
                ('capacity', models.FloatField(choices=[('SATA', 'SATA'), ('SAS', 'SAS'), ('SCSI', 'SCSI'), ('SSD', 'SSD'), ('unknown', 'unknown')], max_length=16, verbose_name='磁盘容量（GB）')),
